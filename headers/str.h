...
API int32_t String_FormatBufVararg(char* buf, size_t len, const char* str, va_list* args);
API int32_t String_FormatBuf(char* buf, size_t len, const char* str, ...);
...
API size_t String_GetArgument(const char* args, char* arg, size_t arrsz, int32_t index);
API const char* String_FromArgument(const char* args, int32_t index);
uint32_t String_CRC32(const uint8_t* str);
API int32_t String_ToInt(const char* str);
API int32_t String_HexToInt(const char* str);
