...
typedef cs_bool(*packetHandler)(Client *, cs_char *);
	...
	*/
	...
	NOINL void CPE_WriteAddEntity(Client *client, cs_int32 ver, Client *other);
	...
	NOINL void CPE_WriteSetMapAppearance(Client *client, cs_int32 ver, CPEAppearance *apps);
