 ...
 * @brief Данный модуль может быть использован плагином сервера
 * для присваивания любому клиенту (либо миру) участка памяти с
 * определённым типом. К одному объекту может быть привязан
 * только один участок памяти одного типа.
 * 
 * Примеры применения ассоциаций можно найти тут:
 ...
 * в случае, если уже было создано максимально допустимое количество
 * ассоциативных типов.
 */
